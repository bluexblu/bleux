...
class ListaDeseos(models.Model):
    usuario = models.ForeignKey('inventario.Usuario', on_delete=models.CASCADE, blank=True, null=True)
    producto = models.ForeignKey('inventario.Producto', on_delete=models.CASCADE, blank=True, null=True)
...
class Carrito(models.Model):
    ...
    usuario = models.ForeignKey('inventario.Usuario', on_delete=models.CASCADE)
...
class ItemPedido(models.Model):
    pedido = models.ForeignKey('inventario.Pedido', related_name='items', on_delete=models.CASCADE)
    producto = models.ForeignKey('inventario.Producto', on_delete=models.CASCADE)
...
class Suscripcion(models.Model):
    usuario = models.ForeignKey('inventario.Usuario', on_delete=models.CASCADE)
    plan = models.CharField(max_length=50, choices=[('Básico', 'Básico'), ('Estándar', 'Estándar'), ('Premium', 'Premium')])
    monto = models.DecimalField(max_digits=10, decimal_places=2)
    fecha_inicio = models.DateField(auto_now_add=True)
    fecha_fin = models.DateField()

    def __str__(self):
        return f"{self.usuario.nombre} - {self.plan}"
